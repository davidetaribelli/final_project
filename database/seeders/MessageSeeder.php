    ...
    public function run()
    {
        ...
        $messages = [
            ...
            [
                ...
                'message' => 'Salve, sarei interessato alla sua presenza per un evento che sto organizzando, mi potrebbe ricontattare il prima possibile? Grazie',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 15,
            ...
            [
                ...
                'message' => 'Salve, sarei interessata   alla sua presenza per un evento che sto organizzando, mi potrebbe ricontattare il prima possibile? Grazie',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 12,
                ...
                'message' => 'Salve, sarei interessato per una festa di compleanno, mi potrebbe ricontattare il prima possibile? Grazie',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 12,
            ...
            [
                ...
                'name' => 'Giada',
                'email' => 'giada@gmail.com',
                'message' => 'Salve, sarei interessata per una festa di compleanno, mi potrebbe ricontattare il prima possibile? Grazie',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 6,
                ...
                'message' => 'Ciao! Sarei interessato alla sua presenza per il battesimo di mio nipote mi potrebbe ricontattare il prima possibile? Grazie',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 6,
                ...
                'message' => 'Ciao, potresti contattarmi telefonicamente al n 3336967908 ?',
                'date' => Carbon::now(),
            ],
            [
                'user_id' => 6,
